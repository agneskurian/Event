<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.master" AutoEventWireup="true" CodeFile="ViewMala.aspx.cs" Inherits="User_ViewMala" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder4" Runat="Server">
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EventConnectionString %>" SelectCommand="SELECT [Productid], [Description], [Availability], [Cost], [Image] FROM [Add_product] WHERE ([Productname] = @Productname)">
            <SelectParameters>
                <asp:Parameter DefaultValue="Flower Mala" Name="Productname" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
